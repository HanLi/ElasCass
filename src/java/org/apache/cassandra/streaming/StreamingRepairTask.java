...
public class StreamingRepairTask implements Runnable
{
    ...
    private void initiateStreaming()
    {
        ...
        try
        {
            ...
            StreamOutSession outsession = StreamOutSession.create(dst, callback);
            StreamOut.transferRanges(outsession, cfstore, ranges, OperationType.AES);
            // request ranges from the remote node
            StreamIn.requestRanges(dst, tableName, cfstore, ranges, callback, OperationType.AES);
        }
        catch(Exception e)
        {
