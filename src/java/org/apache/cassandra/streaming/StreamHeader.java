...
public class StreamHeader
{
    ...
    public StreamHeader(long sessionId, PendingFile file)
    {
        this(sessionId, file, Collections.<PendingFile>emptyList());
    }

    public StreamHeader(long sessionId, PendingFile first, Collection<PendingFile> pendingFiles)
    {
    ...
    private static class StreamHeaderSerializer implements IVersionedSerializer<StreamHeader>
    {
        ...
        public StreamHeader deserialize(DataInput dis, int version) throws IOException
        {
            ...
            return new StreamHeader(sessionId, file, pendingFiles);
        }
