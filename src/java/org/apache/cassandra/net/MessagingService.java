...
import org.apache.cassandra.streaming.FileScpTask;
...
public final class MessagingService implements MessagingServiceMBean
{
    ...
    */
    ...
    public void stream(StreamHeader header, InetAddress to)
    {
        ...
        streamExecutor_.execute(new FileScpTask(header, to));
    }
...
//        if(stage == null)
//        {
//        	String info = new String(message.getMessageBody()) 
//        	+ "\t" + message.getFrom().getHostAddress()
//        	+ "\t" + message.getVerb().toString();
//        	System.err.println("hli@cse\tDEBUG " + info);
//        	logger_.error("hli@cse\tDEBUG " + info);
//        }
