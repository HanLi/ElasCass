...
public class SizeTieredCompactionStrategy extends AbstractCompactionStrategy
{
    ...
    public List<AbstractCompactionTask> getBackgroundTasks(final int gcBefore)
    {
        ...
        List<List<SSTableReader>> buckets = getBuckets(createSSTableAndLengthPairs(cfs.getAllSSTables()), minSSTableSize);
    ...
    public List<AbstractCompactionTask> getMaximalTasks(final int gcBefore)
    {
        ...
        if (!cfs.getAllSSTables().isEmpty())
            tasks.add(new CompactionTask(cfs, cfs.getAllSSTables(), gcBefore));
        return tasks;
    }
    ...
    {
        return cfs.getAllSSTables().size() - sstablesToIgnore.size() > 20;
    }
