...
public class CounterMutation implements IMutation
{
    ...
    {
        return rowMutation.getColumnFamily();
    }
    ...
    public RowMutation makeReplicationMutation() throws IOException
    {
        ...
        if (rowMutation.getColumnFamily().metadata().getReplicateOnWrite())
        {
            addReadCommandFromColumnFamily(rowMutation.getTable(), rowMutation.key(), 
            		rowMutation.getColumnFamily(), readCommands);
        }
        ...
        for (ReadCommand readCommand : readCommands)
        {
            ...
            if (cf.isSuper())
                cf.retainAll(rowMutation.getColumnFamily());
    ...
    {
        return rowMutation.getColumnFamily().metadata().getReplicateOnWrite();
    }
    ...
    public void apply() throws IOException
    {
        ...
        ColumnFamily cf_ = rowMutation.getColumnFamily();
