...
public abstract class SSTable
{
    ...
    public static Map<String, Long> getComponentsWithLengthFor(final Descriptor desc)
    {
        Map<String, Long> components = Maps.newHashMapWithExpectedSize(Component.TYPES.size());
        for (Component.Type componentType : Component.TYPES)
        {
            Component component = new Component(componentType);
            ...
            if (file.exists())
            {
            	components.put(component.name(), file.length());
            }
        }
