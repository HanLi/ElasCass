...
public class NodeProbe
{
    ...
    public Map<Token, Integer> getHotSpotTokens(String tableName, String columnFamily) throws IOException, ExecutionException, InterruptedException
    {
        return ssProxy.getHotSpotTokens(tableName, columnFamily);
    }
    ...
    public Map<String, List<String>> getEndpointToTokensMap(String keyspace, String cfName)
    {
        return ssProxy.getEndpointToTokensMap(keyspace, cfName);
    }
    
    public List<String> getSortedTokens(String keyspace, String cfName)
    {
    	return ssProxy.getSortedTokens(keyspace, cfName);
    }
    ...
    {
        return ssProxy.getLoadMap(keyspace, cfName);
    }
    ...
    public String getTokens(String keyspace, String cfName)
    {
        return ssProxy.getTokens(keyspace, cfName);
    }
    ...
    public void addToken(String tableName, String cfName, String token) throws IOException, InterruptedException, ConfigurationException
    {
        ssProxy.addToken(tableName, cfName, token);
    }

    public void removeToken(String tableName, String cfName, Token token)
    {
        ssProxy.removeToken(tableName, cfName, token);
    }
    ...
    public List<String> describeRing(String keyspaceName, String cfName) throws InvalidRequestException
    {
        return ssProxy.describeRingJMX(keyspaceName, cfName);
    }
}
