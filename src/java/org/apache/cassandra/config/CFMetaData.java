...
public final class CFMetaData
{
    ...
    public final static int DEFAULT_MIN_COMPACTION_THRESHOLD = 2;
    ...
    public final static String DEFAULT_COMPACTION_STRATEGY_CLASS = "RangeCompactionStrategy";
    ...
    public static final CFMetaData PartitionCf = newSystemMetadata(SystemTable.PARTITION_CF, 8, "partitioning information", BytesType.instance, BytesType.instance);
    static
    {
        try
        {
