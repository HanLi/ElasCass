...
public class Config
{
    ...
    /* either is a persistent node or not */
    ...
    public Double hot_spot_ratio = 2.0;
    public Double memtable_live_ratio = 2.0;
    public Integer compaction_max_sstable_in_mb = 1024;
    public Integer replication_factor = 3;
