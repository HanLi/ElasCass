...
public class DatabaseDescriptor
{
    ...
    static
    {
        try
        {
            ...
            if(conf.persistent)
            {
            	logger.info("From hli@cse.unsw.edu.au:\tThis instance is started as a persistent node");
            }
            else
            {
            	logger.info("From hli@cse.unsw.edu.au:\tThis instance is started as a non-persistent node");
            }
           ...
           if (conf.in_memory_compaction_limit_in_mb != null && conf.in_memory_compaction_limit_in_mb <= 0)
            ...
            Schema.instance.load(CFMetaData.PartitionCf);
   ...
   public static String getClusterName()
    ...
    {
        return conf.persistent;
    }
    
    public static long getMaximumSSTableSize()
    {
        return conf.compaction_max_sstable_in_mb * 1024L * 1024L;
    }
    ...
    public static Double getMemTableLiveRatio()
    {
    	return conf.memtable_live_ratio;
    }
    
    public static Double getHotSpotRatio()
    {
    	return conf.hot_spot_ratio;
    }
}
