...
public class DatacenterReadCallback<T> extends ReadCallback<T>
{
    ...
    @Override
    public int determineBlockFor(ConsistencyLevel consistency_level, String table, String cfName)
	{
        NetworkTopologyStrategy stategy = (NetworkTopologyStrategy) Table.open(
