...
public interface StorageServiceMBean
{
    ...
    /**
     * Fetch a string representation of the tokens.
     *
     * @return a string token set
     */
    public String getTokens(String table, String cfName);
    
    /**
     * Fetch a string representation of the local endpoint
     * 
     * @return a string endpoint
     */
    ...
    /**
     * Retrieve a map of endpoint to tokens, including the bootstrapping
     * ones.
     *
     * @return a map of endpoint to tokens
     */
    public Map<String, List<String>> getEndpointToTokensMap(String table, String cfName);
    
    /**
     * Retrieve a list of sorted tokens, including the bootstrapping
     * ones.
     *
     * @return a list of sorted tokens
     */
    ...
    public List<InetAddress> getNaturalEndpoints(String table, String cf, ByteBuffer key);
