...
public class DatacenterWriteResponseHandler extends WriteResponseHandler
{
    ...
    protected DatacenterWriteResponseHandler(Collection<InetAddress> writeEndpoints, 
    		ConsistencyLevel consistencyLevel, String table, String cfName)
    {
        super(writeEndpoints, consistencyLevel, table, cfName);
    ...
    public static IWriteResponseHandler create(Collection<InetAddress> writeEndpoints, 
    		ConsistencyLevel consistencyLevel, String table, String cfName)
    {
        return new DatacenterWriteResponseHandler(writeEndpoints, consistencyLevel, table, cfName);
    }

    @Override
    protected int determineBlockFor(String table, String cfName)
    {
        NetworkTopologyStrategy strategy = (NetworkTopologyStrategy) Table.open(
        		table).getColumnFamilyStore(cfName).getReplicationStrategy();
