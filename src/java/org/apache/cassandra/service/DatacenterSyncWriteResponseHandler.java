...
public class DatacenterSyncWriteResponseHandler extends AbstractWriteResponseHandler
{
    		...
    		ConsistencyLevel consistencyLevel, String table, String cfName)
    {
        ...
        strategy = (NetworkTopologyStrategy) Table.open(table).getColumnFamilyStore(
        		cfName).getReplicationStrategy();
    ...
    public static IWriteResponseHandler create(Collection<InetAddress> writeEndpoints, 
    		ConsistencyLevel consistencyLevel, String table, String cfName)
    {
        return new DatacenterSyncWriteResponseHandler(writeEndpoints, consistencyLevel, table, cfName);
    }
