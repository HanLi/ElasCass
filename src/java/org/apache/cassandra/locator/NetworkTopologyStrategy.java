...
public class NetworkTopologyStrategy extends AbstractReplicationStrategy
{
    ...
    public NetworkTopologyStrategy(String table, String cfName, TokenMetadata tokenMetadata, IEndpointSnitch snitch, Map<String, String> configOptions) throws ConfigurationException
    {
