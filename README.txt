...
To deploy Cassandra from Eclipse:
# cd /Users/hanli/Documents/workspace/cassandra-trunk
# ant
# ant artifacts
...
set Users[hli][first] = 'Han';
set Users[hli][last] = 'Li';
set Users[hli][age] = long(25);
...
create column family data with comparator=UTF8Type
     ...
     and rows_cached=20000;
     


create keyspace reutersnews;
use reutersnews;

create column family fulltext with comparator=UTF8Type 
	and default_validation_class=UTF8Type 
	and key_validation_class=UTF8Type
	and compression_options={sstable_compression:SnappyCompressor, chunk_length_kb:64}
	and rows_cached=20000;

create column family rics with comparator=UTF8Type 
	and default_validation_class=UTF8Type 
	and key_validation_class=UTF8Type
	and compression_options={sstable_compression:SnappyCompressor, chunk_length_kb:64};

create column family newsdates with comparator=UTF8Type 
	and default_validation_class=UTF8Type 
	and key_validation_class=UTF8Type;
